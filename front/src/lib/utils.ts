import type { License, Client } from './queries';
...
export function scrollAndHighlight(clientId: string): void {
...
export function getAccessClients(clients: Client[], projectId: string): Client[] {
