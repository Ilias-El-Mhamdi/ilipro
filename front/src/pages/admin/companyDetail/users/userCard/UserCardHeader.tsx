...
export function UserCardHeader({user, onEditClick, onCopyEmail, copied}: Props) {
    return (
        <div className="bg-indigo-900/40 border-b border-indigo-800/40 px-3 py-3 flex items-center gap-2.5 shrink-0">
            ...
            <div className="min-w-0 flex-1">
                <button onClick={onEditClick} className="group/name flex items-center gap-1.5 cursor-pointer text-left"
                        title="Modifier">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg"
                         className="w-3 h-3 shrink-0 text-gray-600 group-hover/name:text-indigo-400 transition-colors"
                ...
                <div className="flex items-center gap-1 group/email">
                    ...
                    <button onClick={onCopyEmail}
                        ...
                        {copied ? (
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-3 h-3 text-green-400"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-3 h-3" viewBox="0 0 20 20"
                                 fill="currentColor">
