...
export class InitialSchema1780754923888 implements MigrationInterface {
  name = 'InitialSchema1780754923888';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "License"
                             (
                               ...
                               "createdAt"            TIMESTAMP         NOT NULL DEFAULT now(),
                               "updatedAt"            TIMESTAMP         NOT NULL DEFAULT now(),
                               CONSTRAINT "UQ_d92749bff8db91be416ea5eacc7" UNIQUE ("clientId", "companyId"),
